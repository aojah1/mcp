...
This agent has 2 primary tools. One with a RAG capabilities that can answer questions about products and services.
The second is a tool that executes SQL queries in an Oracle database. 
